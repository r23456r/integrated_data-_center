...
public class DgbyServiceImpl {
    public static void main(String[] args) {

        DgbyServiceImpl dgbyService = new DgbyServiceImpl();
        ...
        for (JSONObject node : list) {
            ...
            System.out.println("INSERT INTO `kno_news` VALUES ('" + UUIDUtils.getFullUUID() + "', '10003', '" + node.getString("title") + "', '" + node.getString("content") + "', '" + node.getString("ly") +
                    "', '" +originTime + "', 'dlj', '" + time + "', 'ewct/dgby', '', '0', '0', '" + time + "', '0', '" + node.getString("url") + "');");
    ...
    private String getCotent(String url) {
        ...
        if (imgs.size() > 0) {
            for (Element img : imgs) {
                ...
                if (imgAdd.contains("http")){
                    HttpWormUtils.downloadFromUrl(  imgAdd, "D:\\乌克兰\\大国博弈\\dgby\\", fileName);
                }else{
                    HttpWormUtils.downloadFromUrl("http:" + imgAdd, "D:\\乌克兰\\大国博弈\\dgby\\", fileName);
                }
        ...
        if (videos.size() > 0) {
            for (Element video : videos) {
                ...
                HttpWormUtils.downloadFromUrl(video.attr("https:" + "src"), "D:\\乌克兰\\大国博弈\\dgby\\", fileName);
    ...
    private JSONArray getList() {
        ...
        String urlfirst = "https://mil.news.sina.com.cn/dgby/";
